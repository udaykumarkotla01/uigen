...
export function PreviewFrame() {
  ...
  const handleSpinClick = () => {
    ...
    setIsSpinning(true);
    // Spin for 2 seconds then slowly stop
        ...
        <div className="h-full flex items-center justify-center p-8 bg-gray-50">
          <div className="text-center max-w-md">
            <button
              ...
              className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-blue-100 mb-4 cursor-pointer hover:bg-blue-200 transition-colors"
            >
              <svg
                className={`h-8 w-8 text-blue-600 transition-transform duration-[2000ms] ease-out ${isSpinning ? 'rotate-[720deg]' : 'rotate-0'}`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
